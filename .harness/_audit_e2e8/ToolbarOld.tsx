...
import { type OmniboxResolution } from '../../src/renderer/browser/omnibox'

/* Frozen copies: the live `omnibox.ts` no longer classifies security, because
   the indicator this snapshot exists to show was deleted. This page is the
   "before" picture, so it keeps its own. */
export type Security = 'none' | 'secure' | 'local' | 'insecure'
function securityLabel(security: Security): string {
...
import type { WorkspaceTab } from '../../src/renderer/browser/tabs'
