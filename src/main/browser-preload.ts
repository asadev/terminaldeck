...
export const GUEST_ELEMENT_CHANNEL = 'pawl-browser:element'
/** Main → guest: turn inspection on or off. */
export const GUEST_INSPECT_CHANNEL = 'pawl-browser:set-inspect'
/** Guest → main: the user pressed Escape inside the page. */
export const GUEST_CANCEL_CHANNEL = 'pawl-browser:inspect-cancelled'
...
/* Generated by Pawl from src/main/browser-preload.ts. Do not edit — it is overwritten on launch. */
;(function () {
  ...
  function ensureOverlay() {
    ...
    box.setAttribute('data-pawl-inspector', '')
