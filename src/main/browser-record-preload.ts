 ...
 * *session*. Since the guest views all share the `persist:terminaldeck-browser`
...
export const GUEST_RECORD_CHANNEL = 'terminaldeck-browser:set-record'
/** Guest → main: one observed interaction. Validated by `browser-steps.ts`. */
export const GUEST_STEP_CHANNEL = 'terminaldeck-browser:step'
